...
public class ExtAudioRecorder
{
	...
	{
		return ExtAudioRecorder.getInstance(null, "0", 0, AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT);
	}
	...
	*/
	 ...
	 *
	 */
	public ExtAudioRecorder(WAVRecorder handler, String id, int audioSource, int sampleRate, int channelConfig, int audioFormat)
	{
